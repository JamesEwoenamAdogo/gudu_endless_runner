...
export const login = async(req,res)=>{
    try{
        ...
        return res.json({success:true,token,message:"Login successful",userId:findExisting[0]._id, user: findExisting[0].Scores})
...
export const updateScores = async(req,res)=>{
    try{
        ...
        currentToken = parseInt((currentCoins/5000).toFixed(3),10)
        overallToken = parseInt((overallCoins/5000).toFixed(3), 10)
